      ...
      <div className="portfolio-article-layout">
        ...
        <article>
          ...
          <nav aria-label="Навигация между кейсами" className="portfolio-next">
            <div className="portfolio-next-links">
              {previousCase && (
                <button
                  ...
                  onClick={() => push(`/portfolio/${company.id}/case/${previousCase.id}`)}
                  type="button"
                >
              ...
              {nextCase && (
                <button
                  ...
                  onClick={() => push(`/portfolio/${company.id}/case/${nextCase.id}`)}
                  type="button"
                >
            ...
            <button className="portfolio-all-cases" onClick={() => push(`/portfolio/${company.id}`)} type="button">
